...
ggplot(data=cars, aes(x=z, y=dmiles)) + geom_point()+ geom_smooth(method="lm", formula="dmiles~z")+xlab("Speed (mph)")+ylab("Distance(miles)")
...
all(colnames(excercise)==sampleinfo$sample)
```
